...
class ControlWorld:
    def __init__(self, world_angle=0, box_info=(0.213, 0.255, 0.113, 5), strategy_parameters=(0.04, 0.5)):
    ...
    def generate_box_positions(self):
        for col in range(self.max_col):
            ...
            box_z = self.box_info[2] / 2 + self.drop_height
    ...
    def run_simulation(self, step_time = 50):
        ...
        sim_time = int(len(box_pos_list) * step_time + 1000)
        ...
        for n in range(sim_time):
            ...
            if n % 50 == 0:
                try:
                    ...
                    create_box(self.box_info, box_pos_list[index])
